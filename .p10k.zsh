# Generated by Powerlevel10k configuration wizard on 2022-11-05 at 11:59 CET.
...
() {
  ...
  function my_git_formatter() {
    ...
    # ~42 if have merge conflicts.${VCS_STATUS_NUM_CONFLICTED}
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}ﰣ"
    # +42 if have staged changes.${VCS_STATUS_NUM_STAGED}
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}烙"
    # !42 if have unstaged changes.${VCS_STATUS_NUM_UNSTAGED}
